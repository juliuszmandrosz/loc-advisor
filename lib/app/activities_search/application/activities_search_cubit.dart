...
part 'activities_search_cubit.freezed.dart';
part 'activities_search_state.dart';

@injectable
class ActivitiesSearchCubit extends Cubit<ActivitiesSearchState> {
  final ActivitiesSearchFacade _activitiesFacade;

  ActivitiesSearchCubit(this._activitiesFacade)
      : super(ActivitiesSearchState.initial());
  ...
  Future<void> submitActivities() async {
    ...
    final request = ActivitiesRequestMapper.mapToRequest(state);
