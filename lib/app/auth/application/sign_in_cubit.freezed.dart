...
class _$SignInStateImpl implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(email: $email, password: $password, isFormValid: $isFormValid, status: $status, authFailureOrSuccessOption: $authFailureOrSuccessOption)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, isFormValid,
      status, authFailureOrSuccessOption);
