...
class _$ForgotPasswordStateImpl implements _ForgotPasswordState {
  ...
  @override
  String toString() {
    return 'ForgotPasswordState(email: $email, isFormValid: $isFormValid, status: $status, authFailureOrSuccessOption: $authFailureOrSuccessOption)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, isFormValid, status, authFailureOrSuccessOption);
