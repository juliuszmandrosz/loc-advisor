...
class _$ActivityDtoImpl extends _ActivityDto {
  ...
  @override
  String toString() {
    return 'ActivityDto(placeName: $placeName, description: $description, bestTimeToVisit: $bestTimeToVisit, safetyTips: $safetyTips, combinationTips: $combinationTips, budgetTips: $budgetTips)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, placeName, description,
      bestTimeToVisit, safetyTips, combinationTips, budgetTips);
...
abstract class _ActivityDto extends ActivityDto {
  const factory _ActivityDto(
      ...
      required final String combinationTips,
      required final String budgetTips}) = _$ActivityDtoImpl;
